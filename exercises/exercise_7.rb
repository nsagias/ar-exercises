...
# Employees must always have a store that they belong to (cant have an employee that is not assigned a store)

# Stores must always have a name that is a minimum of 3 characters
# Stores have an annual_revenue that is a number (integer) that must be 0 or more

# BONUS: Stores must carry at least one of the mens or womens apparel (hint: use a custom validation method - dont use a Validator class)
